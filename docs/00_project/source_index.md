...
| Source ID | Title | Type | Priority tier | Status | Where used | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| BG3-OFF-001 | Baldur's Gate 3 official site / game overview | official | A | to read | `docs/03_analysis/00_core_thesis.md`, `docs/03_analysis/01_macro_structure.md` | 作为官方对游戏定位、卖点与系统表达的起点来源。 |
...
| BG3-OFF-003 | Official Xbox Podcast: Baldur’s Gate 3 comes to Xbox and our holiday gift ideas | developer explanation | A | distilled | `.agent/execplan_quests_and_choices.md`, `docs/02_sources/source_note_bg3_off_003_xbox_podcast.md`, `docs/02_sources/case_note_minthara_knockout_path.md`, `docs/03_analysis/02_quests_and_choices.md`, `docs/03_analysis/01_macro_structure.md`, `docs/03_analysis/04_combat_and_environment.md` | Adam Smith 直接解释多入口设计、非常规解法和后续补量对话/结局覆盖。 |
...
| BG3-OFF-006 | Community Update 14: Forging the Arcane | official community update | A | distilled | `.agent/execplan_quests_and_choices.md`, `docs/02_sources/source_note_bg3_off_006_cu14_grymforge.md`, `docs/02_sources/case_note_grymforge_environment_resolution.md`, `docs/03_analysis/04_combat_and_environment.md`, `docs/03_analysis/02_quests_and_choices.md` | 以高层方式确认 Grymforge 兼具任务、选择与复杂战斗遭遇；适合作为 Grymforge / Grym 补强方向的官方框架来源。 |

## BG3 player/community analysis

| Source ID | Title | Type | Priority tier | Status | Where used | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| BG3-PLY-001 | 高质量玩家长文与视频拆解集合（待筛选） | player analysis | B | to read | `docs/02_sources/bg3_player_analysis.md` | 先筛“有案例、有结构、有证据意识”的材料。 |
| BG3-PLY-002 | Reddit: Saving the bard as the Dark Urge | community case | B | reading | `.agent/execplan_quests_and_choices.md`, `docs/02_sources/case_note_dark_urge_bard_event.md`, `docs/03_analysis/02_quests_and_choices.md` | 可用作“长休触发 -> 角色替换 -> 后续可见差异”的案例线索；只能描述玩家案例，不可直接上升为全局事实。 |
